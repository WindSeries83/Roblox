...
|---|---|---|---|
| 0 - vertical slice | En cours | Headless 267/267, 8 skips live ; CI 33960382774 verte sur 51f8b26 ; la session Studio courante n'est pas encore synchronisee avec le HEAD disque | reconnexion Rojo puis smoke Studio sur le HEAD courant ; timings 15-20/30-40 min ; focus/B/Echap manuel ; persistance publiee |
...
- Dernier HEAD applicatif de la candidate : `51f8b262f8a92b30e48b0d00f5cec56fd78d4dbc`.
...
- CI GitHub Actions : [run 33960382774](https://github.com/WindSeries83/Roblox/actions/runs/33960382774), succes sur le HEAD applicatif ci-dessus ; StyLua, Selene, tests headless, Wally, build Rojo et Check diff passent.
