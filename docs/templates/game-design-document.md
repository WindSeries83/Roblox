...
|--------------------------|-----------|----------------------------|--------|
| [e.g., "combo multiplier feeds score"] | `docs/design/score.md` | `combo_multiplier` output value | Data dependency |
| [e.g., "death triggers respawn"] | `docs/design/respawn.md` | Death state transition | State trigger |
| [e.g., "stamina gates dodge"] | `docs/design/stamina.md` | Stamina depletion rule | Rule dependency |
