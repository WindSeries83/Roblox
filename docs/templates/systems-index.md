<!-- Template issu de ai-game-studio (MIT). Projet : RIFT BEASTS (Roblox/Luau). Bible principale : ../RIFT_BEASTS_1_bible_design.md -->
...
|---|-------------|----------|----------|--------|------------|------------|
| 1 | [e.g., Player Controller] | Core | MVP | [Not Started / In Design / In Review / Approved / Implemented] | [docs/design/player-controller.md or "—"] | [e.g., Input System, Physics] |
...
| Order | System | Priority | Layer | Owner(s) | Est. Effort |
|-------|--------|----------|-------|----------|-------------|
| 1 | [First system to design] | MVP | Foundation | [Owner] | [S/M/L] |
| 2 | [Second system] | MVP | Foundation | [Owner] | [S/M/L] |
